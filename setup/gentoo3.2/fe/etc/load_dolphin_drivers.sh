insmod /lib/modules/3.2.73/kernel/drivers/dis/dis_kosif.ko
insmod /lib/modules/3.2.73/kernel/drivers/dis/dis_dx.ko dx_node_id=-1 dx_msi_enable=1 dx_pio_remote_interrupt=1 dx_dma_urgent_timer=0 
dx_dma_normal_timer=0 dx_repl_enable=1 dx_binding_teardown=0 dx_srom_reset=0
insmod /lib/modules/3.2.73/kernel/drivers/dis/dis_irm.ko pcisciInsmodParams=1 dis_max_segment_size_megabytes=4 sci_page_size=1024 
