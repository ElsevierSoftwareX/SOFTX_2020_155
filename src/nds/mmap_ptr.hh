...
template <class T>
   ...
   public:
      ...
      /** Creates an pointer and mappes it to a file.
          @memo Constructor
       ******************************************************************/
      mmap_ptr (const char* filename, std::ios_base::openmode which = 
               std::ios_base::in | std::ios_base::out) : fMmap (0) {
         set (filename, which); }
      ...
      /** Set pointer to a mapped file.
          @memo Set
       ******************************************************************/
      bool set (const char* filename, std::ios_base::openmode which = 
...
template <class T>
   inline bool mmap_ptr<T>::set (const char* filename, 
...
//______________________________________________________________________________
template <class T>
   inline bool mmap_ptr<T>::set (pointer_type p, size_type len) 
   {
      fMmap = new mmap ((gdsbase::mmap::pointer_type)p, len * element_size());
      fCount = ref_counter (fMmap); 
      return get() != 0;   
   }
