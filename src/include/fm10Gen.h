...
/// Structure for shared memory passing of FM coeff info for a single filter module.
...
/// Structure definition for passing FM coeff data for all filter modules in shared memory.
