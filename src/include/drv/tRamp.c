...
inline double RampParamGetVal(RampParamState *state) { return state->val; }

inline int RampParamGetIsRamping(RampParamState *state) {
  return state->isRamping;
}

inline void RampParamInit(RampParamState *state, double xInit,
                          const int fe_rate) {
  state->isRamping = 0;
  state->val = xInit;
  state->dxPrev = 0.0;
...
inline void RampParamLoad(RampParamState *state, double req, double tRamp,
                          const int fe_rate) {
