...
#include "fm10Gen.h"
static const char *fm10Gen_cvsid = "$Id: fm10Gen_biquad.c,v 1.1 2009/07/07 23:05:15 aivanov Exp $";
...
if (INTERLOCK_BANDPASS ==  modNum) {
//output += .5;
                       //if (output >= 0.0) output += 0.5;
                       //else output -= 0.5;

int outp = rint(output);
if (outp > (4*32000)) outp = 4*32000;
if (outp < (4*-32000)) outp = 4*-32000;
//outp &= 0xffff;
output = outp;
}
