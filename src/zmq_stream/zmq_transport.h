...
//extern int zmq_recv_daq_multi_dcu_t_into_buffer(daq_multi_dcu_data_t *dest_buffers, void *socket, int buffer_count);
extern int zmq_recv_daq_multi_dcu_t_into_buffer(daq_multi_dcu_data_t *dest_buffers, pthread_spinlock_t *locks, void *socket, int buffer_count, unsigned int* dest_gps_sec, int* dest_cycle);
