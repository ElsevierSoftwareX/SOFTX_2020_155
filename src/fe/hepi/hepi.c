...
// FILTER MODULE
hmx_spare_fp1 = filterModuleD(dspPtr,dspCoeff,HMX_SPARE_FP1,dWord[1][26],0);

// FILTER MODULE
hmx_spare_fp2 = filterModuleD(dspPtr,dspCoeff,HMX_SPARE_FP2,dWord[1][27],0);

// FILTER MODULE
hmx_spare_rp1 = filterModuleD(dspPtr,dspCoeff,HMX_SPARE_RP1,dWord[1][28],0);

// FILTER MODULE
hmx_spare_rp2 = filterModuleD(dspPtr,dspCoeff,HMX_SPARE_RP2,dWord[1][29],0);

// FILTER MODULE
hmx_spare_rp3 = filterModuleD(dspPtr,dspCoeff,HMX_SPARE_RP3,dWord[1][30],0);
...
// FILTER MODULE
hmy_spare_fp1 = filterModuleD(dspPtr,dspCoeff,HMY_SPARE_FP1,dWord[2][26],0);

// FILTER MODULE
hmy_spare_fp2 = filterModuleD(dspPtr,dspCoeff,HMY_SPARE_FP2,dWord[2][27],0);

// FILTER MODULE
hmy_spare_rp1 = filterModuleD(dspPtr,dspCoeff,HMY_SPARE_RP1,dWord[2][28],0);

// FILTER MODULE
hmy_spare_rp2 = filterModuleD(dspPtr,dspCoeff,HMY_SPARE_RP2,dWord[2][29],0);

// FILTER MODULE
hmy_spare_rp3 = filterModuleD(dspPtr,dspCoeff,HMY_SPARE_RP3,dWord[2][30],0);
...
// FILTER MODULE
sts1_fir_x_pp = filterModuleD(dspPtr,dspCoeff,STS1_FIR_X_PP,dWord[0][23],0);
...
// FILTER MODULE
sts1_fir_y_pp = filterModuleD(dspPtr,dspCoeff,STS1_FIR_Y_PP,dWord[0][24],0);
...
// FILTER MODULE
sts2_fir_x_pp = filterModuleD(dspPtr,dspCoeff,STS2_FIR_X_PP,dWord[1][23],0);
...
// FILTER MODULE
sts2_fir_y_pp = filterModuleD(dspPtr,dspCoeff,STS2_FIR_Y_PP,dWord[1][24],0);
...
// FILTER MODULE
hmx_geo_v1 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_V1,hmx_geo_sum,0);

// FILTER MODULE
hmx_geo_v2 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_V2,hmx_geo_sum1,0);

// FILTER MODULE
hmx_geo_v3 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_V3,hmx_geo_sum2,0);

// FILTER MODULE
hmx_geo_v4 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_V4,hmx_geo_sum3,0);

// FILTER MODULE
hmx_geo_h1 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_H1,hmx_geo_sum4,0);

// FILTER MODULE
hmx_geo_h2 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_H2,hmx_geo_sum5,0);

// FILTER MODULE
hmx_geo_h3 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_H3,hmx_geo_sum6,0);

// FILTER MODULE
hmx_geo_h4 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_H4,hmx_geo_sum7,0);
...
// FILTER MODULE
hmx_geo_x = filterModuleD(dspPtr,dspCoeff,HMX_GEO_X,hmx_geo_mtrx[1][0],0);

// FILTER MODULE
hmx_geo_x_rms2 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_X_RMS2,hmx_geo_mtrx[1][0],0);

// FILTER MODULE
hmx_geo_x_rms = filterModuleD(dspPtr,dspCoeff,HMX_GEO_X_RMS,hmx_geo_mtrx[1][0],0);

// FILTER MODULE
hmx_geo_y = filterModuleD(dspPtr,dspCoeff,HMX_GEO_Y,hmx_geo_mtrx[1][1],0);

// FILTER MODULE
hmx_geo_y_rms2 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_Y_RMS2,hmx_geo_mtrx[1][1],0);

// FILTER MODULE
hmx_geo_y_rms = filterModuleD(dspPtr,dspCoeff,HMX_GEO_Y_RMS,hmx_geo_mtrx[1][1],0);

// FILTER MODULE
hmx_geo_z = filterModuleD(dspPtr,dspCoeff,HMX_GEO_Z,hmx_geo_mtrx[1][2],0);

// FILTER MODULE
hmx_geo_z_rms = filterModuleD(dspPtr,dspCoeff,HMX_GEO_Z_RMS,hmx_geo_mtrx[1][2],0);

// FILTER MODULE
hmx_geo_z_rms2 = filterModuleD(dspPtr,dspCoeff,HMX_GEO_Z_RMS2,hmx_geo_mtrx[1][2],0);

// FILTER MODULE
hmx_geo_rz = filterModuleD(dspPtr,dspCoeff,HMX_GEO_RZ,hmx_geo_mtrx[1][5],0);

// FILTER MODULE
hmx_geo_vp = filterModuleD(dspPtr,dspCoeff,HMX_GEO_VP,hmx_geo_mtrx[1][6],0);

// FILTER MODULE
hmx_geo_hp = filterModuleD(dspPtr,dspCoeff,HMX_GEO_HP,hmx_geo_mtrx[1][7],0);

// FILTER MODULE
hmx_geo_rx = filterModuleD(dspPtr,dspCoeff,HMX_GEO_RX,hmx_geo_mtrx[1][3],0);

// FILTER MODULE
hmx_geo_ry = filterModuleD(dspPtr,dspCoeff,HMX_GEO_RY,hmx_geo_mtrx[1][4],0);
...
// FILTER MODULE
hmy_geo_v1 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_V1,hmy_geo_sum,0);

// FILTER MODULE
hmy_geo_v2 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_V2,hmy_geo_sum1,0);

// FILTER MODULE
hmy_geo_v3 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_V3,hmy_geo_sum2,0);

// FILTER MODULE
hmy_geo_v4 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_V4,hmy_geo_sum3,0);

// FILTER MODULE
hmy_geo_h1 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_H1,hmy_geo_sum4,0);

// FILTER MODULE
hmy_geo_h2 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_H2,hmy_geo_sum5,0);

// FILTER MODULE
hmy_geo_h3 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_H3,hmy_geo_sum6,0);

// FILTER MODULE
hmy_geo_h4 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_H4,hmy_geo_sum7,0);
...
// FILTER MODULE
hmy_geo_x = filterModuleD(dspPtr,dspCoeff,HMY_GEO_X,hmy_geo_mtrx[1][0],0);

// FILTER MODULE
hmy_geo_x_rms2 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_X_RMS2,hmy_geo_mtrx[1][0],0);

// FILTER MODULE
hmy_geo_x_rms = filterModuleD(dspPtr,dspCoeff,HMY_GEO_X_RMS,hmy_geo_mtrx[1][0],0);

// FILTER MODULE
hmy_geo_y = filterModuleD(dspPtr,dspCoeff,HMY_GEO_Y,hmy_geo_mtrx[1][1],0);

// FILTER MODULE
hmy_geo_y_rms2 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_Y_RMS2,hmy_geo_mtrx[1][1],0);

// FILTER MODULE
hmy_geo_y_rms = filterModuleD(dspPtr,dspCoeff,HMY_GEO_Y_RMS,hmy_geo_mtrx[1][1],0);

// FILTER MODULE
hmy_geo_z = filterModuleD(dspPtr,dspCoeff,HMY_GEO_Z,hmy_geo_mtrx[1][2],0);

// FILTER MODULE
hmy_geo_z_rms = filterModuleD(dspPtr,dspCoeff,HMY_GEO_Z_RMS,hmy_geo_mtrx[1][2],0);

// FILTER MODULE
hmy_geo_z_rms2 = filterModuleD(dspPtr,dspCoeff,HMY_GEO_Z_RMS2,hmy_geo_mtrx[1][2],0);

// FILTER MODULE
hmy_geo_rz = filterModuleD(dspPtr,dspCoeff,HMY_GEO_RZ,hmy_geo_mtrx[1][5],0);

// FILTER MODULE
hmy_geo_vp = filterModuleD(dspPtr,dspCoeff,HMY_GEO_VP,hmy_geo_mtrx[1][6],0);

// FILTER MODULE
hmy_geo_hp = filterModuleD(dspPtr,dspCoeff,HMY_GEO_HP,hmy_geo_mtrx[1][7],0);

// FILTER MODULE
hmy_geo_rx = filterModuleD(dspPtr,dspCoeff,HMY_GEO_RX,hmy_geo_mtrx[1][3],0);

// FILTER MODULE
hmy_geo_ry = filterModuleD(dspPtr,dspCoeff,HMY_GEO_RY,hmy_geo_mtrx[1][4],0);
...
// FILTER MODULE
hmx_fir_x_out = filterModuleD(dspPtr,dspCoeff,HMX_FIR_X_OUT,hmx_fir_mtrx[1][0],0);

// FILTER MODULE
hmx_fir_y_out = filterModuleD(dspPtr,dspCoeff,HMX_FIR_Y_OUT,hmx_fir_mtrx[1][1],0);
...
// FILTER MODULE
hmx_sts_y = filterModuleD(dspPtr,dspCoeff,HMX_STS_Y,hmx_sts_in_mtrx[1][1],0);

// FILTER MODULE
hmx_sts_x = filterModuleD(dspPtr,dspCoeff,HMX_STS_X,hmx_sts_in_mtrx[1][0],0);

// FILTER MODULE
hmx_sts_z = filterModuleD(dspPtr,dspCoeff,HMX_STS_Z,hmx_sts_in_mtrx[1][2],0);
...
// FILTER MODULE
hmx_sts_y_rx = filterModuleD(dspPtr,dspCoeff,HMX_STS_Y_RX,hmx_sts_ramp_sw[1],0);
...
// FILTER MODULE
hmx_sts_x_ry = filterModuleD(dspPtr,dspCoeff,HMX_STS_X_RY,hmx_sts_ramp_sw[0],0);
...
// FILTER MODULE
hmx_wd_stsx = filterModuleD(dspPtr,dspCoeff,HMX_WD_STSX,hmx_sts_in_mtrx[1][0],0);

// FILTER MODULE
hmx_wd_stsy = filterModuleD(dspPtr,dspCoeff,HMX_WD_STSY,hmx_sts_in_mtrx[1][1],0);

// FILTER MODULE
hmx_wd_stsz = filterModuleD(dspPtr,dspCoeff,HMX_WD_STSZ,hmx_sts_in_mtrx[1][2],0);

// FILTER MODULE
hmx_wd_pos_v1 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_V1,dWord[1][12],0);

// FILTER MODULE
hmx_wd_pos_v2 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_V2,dWord[1][13],0);

// FILTER MODULE
hmx_wd_pos_v3 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_V3,dWord[1][14],0);

// FILTER MODULE
hmx_wd_pos_v4 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_V4,dWord[1][15],0);

// FILTER MODULE
hmx_wd_pos_h1 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_H1,dWord[1][8],0);

// FILTER MODULE
hmx_wd_pos_h2 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_H2,dWord[1][9],0);

// FILTER MODULE
hmx_wd_pos_h3 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_H3,dWord[1][10],0);

// FILTER MODULE
hmx_wd_pos_h4 = filterModuleD(dspPtr,dspCoeff,HMX_WD_POS_H4,dWord[1][11],0);

// FILTER MODULE
hmx_wd_geo_v1 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_V1,dWord[1][4],0);

// FILTER MODULE
hmx_wd_geo_v2 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_V2,dWord[1][5],0);

// FILTER MODULE
hmx_wd_geo_v3 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_V3,dWord[1][6],0);

// FILTER MODULE
hmx_wd_geo_v4 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_V4,dWord[1][7],0);

// FILTER MODULE
hmx_wd_geo_h1 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_H1,dWord[1][0],0);

// FILTER MODULE
hmx_wd_geo_h2 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_H2,dWord[1][1],0);

// FILTER MODULE
hmx_wd_geo_h3 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_H3,dWord[1][2],0);

// FILTER MODULE
hmx_wd_geo_h4 = filterModuleD(dspPtr,dspCoeff,HMX_WD_GEO_H4,dWord[1][3],0);
...
// FILTER MODULE
hmy_fir_x_out = filterModuleD(dspPtr,dspCoeff,HMY_FIR_X_OUT,hmy_fir_mtrx[1][0],0);

// FILTER MODULE
hmy_fir_y_out = filterModuleD(dspPtr,dspCoeff,HMY_FIR_Y_OUT,hmy_fir_mtrx[1][1],0);
...
// FILTER MODULE
hmy_sts_y = filterModuleD(dspPtr,dspCoeff,HMY_STS_Y,hmy_sts_in_mtrx[1][1],0);

// FILTER MODULE
hmy_sts_x = filterModuleD(dspPtr,dspCoeff,HMY_STS_X,hmy_sts_in_mtrx[1][0],0);

// FILTER MODULE
hmy_sts_z = filterModuleD(dspPtr,dspCoeff,HMY_STS_Z,hmy_sts_in_mtrx[1][2],0);
...
// FILTER MODULE
hmy_sts_y_rx = filterModuleD(dspPtr,dspCoeff,HMY_STS_Y_RX,hmy_sts_ramp_sw[1],0);
...
// FILTER MODULE
hmy_sts_x_ry = filterModuleD(dspPtr,dspCoeff,HMY_STS_X_RY,hmy_sts_ramp_sw[0],0);
...
// FILTER MODULE
hmy_wd_stsx = filterModuleD(dspPtr,dspCoeff,HMY_WD_STSX,hmy_sts_in_mtrx[1][0],0);

// FILTER MODULE
hmy_wd_stsy = filterModuleD(dspPtr,dspCoeff,HMY_WD_STSY,hmy_sts_in_mtrx[1][1],0);

// FILTER MODULE
hmy_wd_stsz = filterModuleD(dspPtr,dspCoeff,HMY_WD_STSZ,hmy_sts_in_mtrx[1][2],0);

// FILTER MODULE
hmy_wd_pos_v1 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_V1,dWord[2][12],0);

// FILTER MODULE
hmy_wd_pos_v2 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_V2,dWord[2][13],0);

// FILTER MODULE
hmy_wd_pos_v3 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_V3,dWord[2][14],0);

// FILTER MODULE
hmy_wd_pos_v4 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_V4,dWord[2][15],0);

// FILTER MODULE
hmy_wd_pos_h1 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_H1,dWord[2][8],0);

// FILTER MODULE
hmy_wd_pos_h2 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_H2,dWord[2][9],0);

// FILTER MODULE
hmy_wd_pos_h3 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_H3,dWord[2][10],0);

// FILTER MODULE
hmy_wd_pos_h4 = filterModuleD(dspPtr,dspCoeff,HMY_WD_POS_H4,dWord[2][11],0);

// FILTER MODULE
hmy_wd_geo_v1 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_V1,dWord[2][4],0);

// FILTER MODULE
hmy_wd_geo_v2 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_V2,dWord[2][5],0);

// FILTER MODULE
hmy_wd_geo_v3 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_V3,dWord[2][6],0);

// FILTER MODULE
hmy_wd_geo_v4 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_V4,dWord[2][7],0);

// FILTER MODULE
hmy_wd_geo_h1 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_H1,dWord[2][0],0);

// FILTER MODULE
hmy_wd_geo_h2 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_H2,dWord[2][1],0);

// FILTER MODULE
hmy_wd_geo_h3 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_H3,dWord[2][2],0);

// FILTER MODULE
hmy_wd_geo_h4 = filterModuleD(dspPtr,dspCoeff,HMY_WD_GEO_H4,dWord[2][3],0);
...
// FILTER MODULE
hmx_pos_v1 = filterModuleD(dspPtr,dspCoeff,HMX_POS_V1,dWord[1][12],0);

// FILTER MODULE
hmx_pos_v2 = filterModuleD(dspPtr,dspCoeff,HMX_POS_V2,dWord[1][13],0);

// FILTER MODULE
hmx_pos_v3 = filterModuleD(dspPtr,dspCoeff,HMX_POS_V3,dWord[1][14],0);

// FILTER MODULE
hmx_pos_v4 = filterModuleD(dspPtr,dspCoeff,HMX_POS_V4,dWord[1][15],0);

// FILTER MODULE
hmx_pos_h1 = filterModuleD(dspPtr,dspCoeff,HMX_POS_H1,dWord[1][8],0);

// FILTER MODULE
hmx_pos_h2 = filterModuleD(dspPtr,dspCoeff,HMX_POS_H2,dWord[1][9],0);

// FILTER MODULE
hmx_pos_h3 = filterModuleD(dspPtr,dspCoeff,HMX_POS_H3,dWord[1][10],0);

// FILTER MODULE
hmx_pos_h4 = filterModuleD(dspPtr,dspCoeff,HMX_POS_H4,dWord[1][11],0);
...
// FILTER MODULE
hmx_pos_x = filterModuleD(dspPtr,dspCoeff,HMX_POS_X,hmx_pos_mtrx[1][0],0);

// FILTER MODULE
hmx_pos_y = filterModuleD(dspPtr,dspCoeff,HMX_POS_Y,hmx_pos_mtrx[1][1],0);

// FILTER MODULE
hmx_pos_z = filterModuleD(dspPtr,dspCoeff,HMX_POS_Z,hmx_pos_mtrx[1][2],0);

// FILTER MODULE
hmx_pos_rz = filterModuleD(dspPtr,dspCoeff,HMX_POS_RZ,hmx_pos_mtrx[1][5],0);

// FILTER MODULE
hmx_pos_vp = filterModuleD(dspPtr,dspCoeff,HMX_POS_VP,hmx_pos_mtrx[1][6],0);

// FILTER MODULE
hmx_pos_hp = filterModuleD(dspPtr,dspCoeff,HMX_POS_HP,hmx_pos_mtrx[1][7],0);
...
// FILTER MODULE
hmx_pos_rx = filterModuleD(dspPtr,dspCoeff,HMX_POS_RX,hmx_pos_sum,0);

// FILTER MODULE
hmx_pos_ry = filterModuleD(dspPtr,dspCoeff,HMX_POS_RY,hmx_pos_sum1,0);
...
// FILTER MODULE
hmy_pos_v1 = filterModuleD(dspPtr,dspCoeff,HMY_POS_V1,dWord[2][12],0);

// FILTER MODULE
hmy_pos_v2 = filterModuleD(dspPtr,dspCoeff,HMY_POS_V2,dWord[2][13],0);

// FILTER MODULE
hmy_pos_v3 = filterModuleD(dspPtr,dspCoeff,HMY_POS_V3,dWord[2][14],0);

// FILTER MODULE
hmy_pos_v4 = filterModuleD(dspPtr,dspCoeff,HMY_POS_V4,dWord[2][15],0);

// FILTER MODULE
hmy_pos_h1 = filterModuleD(dspPtr,dspCoeff,HMY_POS_H1,dWord[2][8],0);

// FILTER MODULE
hmy_pos_h2 = filterModuleD(dspPtr,dspCoeff,HMY_POS_H2,dWord[2][9],0);

// FILTER MODULE
hmy_pos_h3 = filterModuleD(dspPtr,dspCoeff,HMY_POS_H3,dWord[2][10],0);

// FILTER MODULE
hmy_pos_h4 = filterModuleD(dspPtr,dspCoeff,HMY_POS_H4,dWord[2][11],0);
...
// FILTER MODULE
hmy_pos_x = filterModuleD(dspPtr,dspCoeff,HMY_POS_X,hmy_pos_mtrx[1][0],0);

// FILTER MODULE
hmy_pos_y = filterModuleD(dspPtr,dspCoeff,HMY_POS_Y,hmy_pos_mtrx[1][1],0);

// FILTER MODULE
hmy_pos_z = filterModuleD(dspPtr,dspCoeff,HMY_POS_Z,hmy_pos_mtrx[1][2],0);

// FILTER MODULE
hmy_pos_rz = filterModuleD(dspPtr,dspCoeff,HMY_POS_RZ,hmy_pos_mtrx[1][5],0);

// FILTER MODULE
hmy_pos_vp = filterModuleD(dspPtr,dspCoeff,HMY_POS_VP,hmy_pos_mtrx[1][6],0);

// FILTER MODULE
hmy_pos_hp = filterModuleD(dspPtr,dspCoeff,HMY_POS_HP,hmy_pos_mtrx[1][7],0);
...
// FILTER MODULE
hmy_pos_rx = filterModuleD(dspPtr,dspCoeff,HMY_POS_RX,hmy_pos_sum,0);

// FILTER MODULE
hmy_pos_ry = filterModuleD(dspPtr,dspCoeff,HMY_POS_RY,hmy_pos_sum1,0);
...
// FILTER MODULE
hmx_x = filterModuleD(dspPtr,dspCoeff,HMX_X,hmx_sum,0);

// FILTER MODULE
hmx_y = filterModuleD(dspPtr,dspCoeff,HMX_Y,hmx_sum1,0);

// FILTER MODULE
hmx_z = filterModuleD(dspPtr,dspCoeff,HMX_Z,hmx_sum2,0);

// FILTER MODULE
hmx_rx = filterModuleD(dspPtr,dspCoeff,HMX_RX,hmx_sum3,0);

// FILTER MODULE
hmx_ry = filterModuleD(dspPtr,dspCoeff,HMX_RY,hmx_sum4,0);

// FILTER MODULE
hmx_rz = filterModuleD(dspPtr,dspCoeff,HMX_RZ,hmx_sum5,0);

// FILTER MODULE
hmx_vp = filterModuleD(dspPtr,dspCoeff,HMX_VP,hmx_sum6,0);

// FILTER MODULE
hmx_hp = filterModuleD(dspPtr,dspCoeff,HMX_HP,hmx_sum7,0);
...
pLocalEpics->sei.HMX_LOOP_GAIN_RMON = 
	gainRamp(pLocalEpics->sei.HMX_LOOP_GAIN,pLocalEpics->sei.HMX_LOOP_GAIN_TRAMP,3,&HMX_LOOP_GAIN_CALC);

hmx_loop_gain[0] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][0];
hmx_loop_gain[1] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][1];
hmx_loop_gain[2] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][2];
hmx_loop_gain[3] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][3];
hmx_loop_gain[4] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][4];
hmx_loop_gain[5] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][5];
hmx_loop_gain[6] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][6];
hmx_loop_gain[7] = HMX_LOOP_GAIN_CALC * hmx_mtrx[1][7];
...
// FILTER MODULE
hmx_tiltcorr_v1 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_V1,hmx_tiltcorr_mtrx[1][0],0);

// FILTER MODULE
hmx_tiltcorr_v2 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_V2,hmx_tiltcorr_mtrx[1][1],0);

// FILTER MODULE
hmx_tiltcorr_v3 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_V3,hmx_tiltcorr_mtrx[1][2],0);

// FILTER MODULE
hmx_tiltcorr_v4 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_V4,hmx_tiltcorr_mtrx[1][3],0);

// FILTER MODULE
hmx_tiltcorr_h1 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_H1,hmx_tiltcorr_mtrx[1][4],0);

// FILTER MODULE
hmx_tiltcorr_h2 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_H2,hmx_tiltcorr_mtrx[1][5],0);

// FILTER MODULE
hmx_tiltcorr_h3 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_H3,hmx_tiltcorr_mtrx[1][6],0);

// FILTER MODULE
hmx_tiltcorr_h4 = filterModuleD(dspPtr,dspCoeff,HMX_TILTCORR_H4,hmx_tiltcorr_mtrx[1][7],0);

// PRODUCT
pLocalEpics->sei.HMX_TILTCORR_GAIN_RMON = 
	gainRamp(pLocalEpics->sei.HMX_TILTCORR_GAIN,pLocalEpics->sei.HMX_TILTCORR_GAIN_TRAMP,4,&HMX_TILTCORR_GAIN_CALC);

hmx_tiltcorr_gain[0] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_v1;
hmx_tiltcorr_gain[1] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_v2;
hmx_tiltcorr_gain[2] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_v3;
hmx_tiltcorr_gain[3] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_v4;
hmx_tiltcorr_gain[4] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_h1;
hmx_tiltcorr_gain[5] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_h2;
hmx_tiltcorr_gain[6] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_h3;
hmx_tiltcorr_gain[7] = HMX_TILTCORR_GAIN_CALC * hmx_tiltcorr_h4;
...
// FILTER MODULE
hmx_act_v1 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_V1,hmx_act_sum,0);

// FILTER MODULE
hmx_act_v2 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_V2,hmx_act_sum1,0);

// FILTER MODULE
hmx_act_v3 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_V3,hmx_act_sum2,0);

// FILTER MODULE
hmx_act_v4 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_V4,hmx_act_sum3,0);

// FILTER MODULE
hmx_act_h1 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_H1,hmx_act_sum4,0);

// FILTER MODULE
hmx_act_h2 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_H2,hmx_act_sum5,0);

// FILTER MODULE
hmx_act_h3 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_H3,hmx_act_sum6,0);

// FILTER MODULE
hmx_act_h4 = filterModuleD(dspPtr,dspCoeff,HMX_ACT_H4,hmx_act_sum7,0);

// PRODUCT
pLocalEpics->sei.HMX_ACT_GAIN_RMON = 
	gainRamp(pLocalEpics->sei.HMX_ACT_GAIN,pLocalEpics->sei.HMX_ACT_GAIN_TRAMP,5,&HMX_ACT_GAIN_CALC);

hmx_act_gain[0] = HMX_ACT_GAIN_CALC * hmx_act_v1;
hmx_act_gain[1] = HMX_ACT_GAIN_CALC * hmx_act_v2;
hmx_act_gain[2] = HMX_ACT_GAIN_CALC * hmx_act_v3;
hmx_act_gain[3] = HMX_ACT_GAIN_CALC * hmx_act_v4;
hmx_act_gain[4] = HMX_ACT_GAIN_CALC * hmx_act_h1;
hmx_act_gain[5] = HMX_ACT_GAIN_CALC * hmx_act_h2;
hmx_act_gain[6] = HMX_ACT_GAIN_CALC * hmx_act_h3;
hmx_act_gain[7] = HMX_ACT_GAIN_CALC * hmx_act_h4;
...
// FILTER MODULE
hmy_x = filterModuleD(dspPtr,dspCoeff,HMY_X,hmy_sum,0);

// FILTER MODULE
hmy_y = filterModuleD(dspPtr,dspCoeff,HMY_Y,hmy_sum1,0);

// FILTER MODULE
hmy_z = filterModuleD(dspPtr,dspCoeff,HMY_Z,hmy_sum2,0);

// FILTER MODULE
hmy_rx = filterModuleD(dspPtr,dspCoeff,HMY_RX,hmy_sum3,0);

// FILTER MODULE
hmy_ry = filterModuleD(dspPtr,dspCoeff,HMY_RY,hmy_sum4,0);

// FILTER MODULE
hmy_rz = filterModuleD(dspPtr,dspCoeff,HMY_RZ,hmy_sum5,0);

// FILTER MODULE
hmy_vp = filterModuleD(dspPtr,dspCoeff,HMY_VP,hmy_sum6,0);

// FILTER MODULE
hmy_hp = filterModuleD(dspPtr,dspCoeff,HMY_HP,hmy_sum7,0);
...
pLocalEpics->sei.HMY_LOOP_GAIN_RMON = 
	gainRamp(pLocalEpics->sei.HMY_LOOP_GAIN,pLocalEpics->sei.HMY_LOOP_GAIN_TRAMP,6,&HMY_LOOP_GAIN_CALC);

hmy_loop_gain[0] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][0];
hmy_loop_gain[1] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][1];
hmy_loop_gain[2] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][2];
hmy_loop_gain[3] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][3];
hmy_loop_gain[4] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][4];
hmy_loop_gain[5] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][5];
hmy_loop_gain[6] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][6];
hmy_loop_gain[7] = HMY_LOOP_GAIN_CALC * hmy_mtrx[1][7];
...
// FILTER MODULE
hmy_tiltcorr_v1 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_V1,hmy_tiltcorr_mtrx[1][0],0);

// FILTER MODULE
hmy_tiltcorr_v2 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_V2,hmy_tiltcorr_mtrx[1][1],0);

// FILTER MODULE
hmy_tiltcorr_v3 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_V3,hmy_tiltcorr_mtrx[1][2],0);

// FILTER MODULE
hmy_tiltcorr_v4 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_V4,hmy_tiltcorr_mtrx[1][3],0);

// FILTER MODULE
hmy_tiltcorr_h1 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_H1,hmy_tiltcorr_mtrx[1][4],0);

// FILTER MODULE
hmy_tiltcorr_h2 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_H2,hmy_tiltcorr_mtrx[1][5],0);

// FILTER MODULE
hmy_tiltcorr_h3 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_H3,hmy_tiltcorr_mtrx[1][6],0);

// FILTER MODULE
hmy_tiltcorr_h4 = filterModuleD(dspPtr,dspCoeff,HMY_TILTCORR_H4,hmy_tiltcorr_mtrx[1][7],0);

// PRODUCT
pLocalEpics->sei.HMY_TILTCORR_GAIN_RMON = 
	gainRamp(pLocalEpics->sei.HMY_TILTCORR_GAIN,pLocalEpics->sei.HMY_TILTCORR_GAIN_TRAMP,7,&HMY_TILTCORR_GAIN_CALC);

hmy_tiltcorr_gain[0] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_v1;
hmy_tiltcorr_gain[1] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_v2;
hmy_tiltcorr_gain[2] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_v3;
hmy_tiltcorr_gain[3] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_v4;
hmy_tiltcorr_gain[4] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_h1;
hmy_tiltcorr_gain[5] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_h2;
hmy_tiltcorr_gain[6] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_h3;
hmy_tiltcorr_gain[7] = HMY_TILTCORR_GAIN_CALC * hmy_tiltcorr_h4;
...
// FILTER MODULE
hmy_act_v1 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_V1,hmy_act_sum,0);

// FILTER MODULE
hmy_act_v2 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_V2,hmy_act_sum1,0);

// FILTER MODULE
hmy_act_v3 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_V3,hmy_act_sum2,0);

// FILTER MODULE
hmy_act_v4 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_V4,hmy_act_sum3,0);

// FILTER MODULE
hmy_act_h1 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_H1,hmy_act_sum4,0);

// FILTER MODULE
hmy_act_h2 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_H2,hmy_act_sum5,0);

// FILTER MODULE
hmy_act_h3 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_H3,hmy_act_sum6,0);

// FILTER MODULE
hmy_act_h4 = filterModuleD(dspPtr,dspCoeff,HMY_ACT_H4,hmy_act_sum7,0);

// PRODUCT
pLocalEpics->sei.HMY_ACT_GAIN_RMON = 
	gainRamp(pLocalEpics->sei.HMY_ACT_GAIN,pLocalEpics->sei.HMY_ACT_GAIN_TRAMP,8,&HMY_ACT_GAIN_CALC);

hmy_act_gain[0] = HMY_ACT_GAIN_CALC * hmy_act_v1;
hmy_act_gain[1] = HMY_ACT_GAIN_CALC * hmy_act_v2;
hmy_act_gain[2] = HMY_ACT_GAIN_CALC * hmy_act_v3;
hmy_act_gain[3] = HMY_ACT_GAIN_CALC * hmy_act_v4;
hmy_act_gain[4] = HMY_ACT_GAIN_CALC * hmy_act_h1;
hmy_act_gain[5] = HMY_ACT_GAIN_CALC * hmy_act_h2;
hmy_act_gain[6] = HMY_ACT_GAIN_CALC * hmy_act_h3;
hmy_act_gain[7] = HMY_ACT_GAIN_CALC * hmy_act_h4;
