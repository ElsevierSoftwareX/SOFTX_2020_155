...
typedef struct {
  ...
  pthread_cond_t notfull;                     /* consumer will signal notfull
						      after it gets the block */
  pthread_cond_t notempty;                /* producer broadcasts this 
			                     after it has filled in new block */
  pthread_cond_t notempty16th;           /* producer broadcasts this after it
			                    has filled in new 1/16 of a block */
} circ_buffer_block_t;
