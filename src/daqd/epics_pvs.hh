...
enum PV_NAME {
    ...
    // Producer/Debug/CRC timing
    PV_PRDCR_DBG_CRC_TIME_FULL_MEAN_MS,
    PV_PRDCR_DBG_CRC_TIME_FULL_MIN_MS,
    PV_PRDCR_DBG_CRC_TIME_FULL_MAX_MS,
...
static inline daqd_atomic_uint &pv(PV_NAME pv) {
    return ::pvValue[pv];
}

static inline void incr_pv(PV_NAME pv) {
    ::pvValue[pv]++;
}

static inline void incr_pv(PV_NAME pv, unsigned int n) {
