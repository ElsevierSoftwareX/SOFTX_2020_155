...
cnt1 = PV('X1:CDS-RFM_SWITCH_CHCNT1')
cnt2 = PV('X1:CDS-RFM_SWITCH_CHCNT2')
cnt3 = PV('X1:CDS-RFM_SWITCH_CHCNT3')
act01 = PV('X1:CDS-RFM_SWITCH_ACTIVE01')
act02 = PV('X1:CDS-RFM_SWITCH_ACTIVE02')
act03 = PV('X1:CDS-RFM_SWITCH_ACTIVE03')
act11 = PV('X1:CDS-RFM_SWITCH_ACTIVE11')
act12 = PV('X1:CDS-RFM_SWITCH_ACTIVE12')
act13 = PV('X1:CDS-RFM_SWITCH_ACTIVE13')
