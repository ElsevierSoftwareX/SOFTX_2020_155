...
sub createGdsMedm
{
 ...
 # Define colors to be sent to screen gen.
	...
	# Create MEDM File
	my $xpos = 0; my $ypos = 0; my $width = 785; my $height = 335;
	...
	$xpos = 11; $ypos = 69; $width = 765; $height = 255;
        $medmdata .= ("CDS::medmGen::medmGenRectangle") -> ($xpos,$ypos,$width,$height,$ecolors{gray},"","","");
	$xpos = 555; $ypos = 24; $width = 220; $height = 43;
        $medmdata .= ("CDS::medmGen::medmGenRectangle") -> ($xpos,$ypos,$width,$height,$ecolors{gray},"","","");
	$xpos = 11; $ypos = 69; $width = 765; $height = 18;
        $medmdata .= ("CDS::medmGen::medmGenRectangle") -> ($xpos,$ypos,$width,$height,$ecolors{blue},"","","");
	...
	$medmdata .= ("CDS::medmGen::medmGenText") -> ($xpos,$ypos,$width,$height," FAST  EPICS DRATE  TRATE",$ecolors{black});
	...
	$xpos = 384; $ypos = 145; $width = 35; $height = 15;
